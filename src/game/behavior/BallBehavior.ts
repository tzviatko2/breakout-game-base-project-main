...
export class BallBehavior extends GameObjectBehavior {
  ...
  private checkOutOfBound(moveDist: PIXI.Point): boolean {
    return (
      this.gameObjRef.y + this.gameObjRef.height * 0.5 + moveDist.y >
        this.paddleRef.y + this.paddleRef.height &&
      (this.gameObjRef.x + this.gameObjRef.width * 0.5 < this.paddleRef.x ||
        this.gameObjRef.x - this.gameObjRef.width * 0.5 >
